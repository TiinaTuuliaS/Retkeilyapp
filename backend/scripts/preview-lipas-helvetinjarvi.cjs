...
const dir = path.join(root, 'data-preview/lipas-helvetinjarvi');
...
assert.equal(boundary.features[0].properties.LsAlueTunn,'KPU040005');
...
const summary={generatedAt:new Date().toISOString(),sourceFile,lipasSnapshotAt:'2026-09-07T15:55:48.879Z',
  ...
  boundaryFetchedOn:'2026-09-12',boundaryId:'KPU040005',boundaryModifiedAt:new Date(boundary.features[0].properties.MuutosPvm).toISOString(),
